            ...
            <div class="vipNav">
                ...
                <dl>
                    ...
                    <dd>
                        ...
                        <a href="user_shenqing.jsp" class="vipNavCur">申请社区自由经纪人</a>
        ...
        <div class="vip-right">
            ...
            <table class="grinfo">
                ...
                <tr>
                    ...
                    <td>
                        <input class="inp inw" type="text" id="work_years" value="" maxlength="2"
                               onkeyup="return ValidateNumber(this,value)">年
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div style="clear:both;">
                            <div style="clear:both;">
                                ...
                                <div style="float:left;"><input name="occ_cert" type="text" class="input" id="occ_cert"
                                                                title="双击查看图片" ondblclick="veiwPic(this);" size="30"
                ...
                <tr>
                    ...
                    <td>
                        <div id="bee_countys1">
                            <select id="bee_county1" onchange="mod_street($('#bee_county1').val(),'1');">
                            ...
                            <select id="bee_street1" onchange="change_villages($('#bee_street1').val(),1)">
                                <option value="1">安慧桥</option>
                                ...
                                <option value="78">左家庄</option>
                            </select>
                            <script>mod_street($('#bee_county1').val(), '1', '');</script>
                        </div>
                        <div id="bee_countys2">
                            <select id="bee_county2" onchange="mod_street($('#bee_county2').val(),'2');">
                                <option value="4">西城</option>
                                <option value="2">海淀</option>
                                <option value="12">大兴</option>
                                <option value="19">燕郊</option>
                            ...
                            <select id="bee_street2" onchange="change_villages($('#bee_street2').val(),2)">
                                <option value="160">百万庄</option>
                                ...
                                <option value="185">真武庙</option>
                            </select>
                            <script>mod_street($('#bee_county2').val(), '2', '');</script>
                            <span class="add_street" onclick="del_street(2)">删除</span>
                        </div>
                        <div id="bee_countys3">
                            <select id="bee_county3" onchange="mod_street($('#bee_county3').val(),'3');">
                                <option value="15">怀柔</option>
                                <option value="12">大兴</option>
                                <option value="16">延庆</option>
                                <option value="3">东城</option>
                            ...
                            <select id="bee_street3" onchange="change_villages($('#bee_street1').val(),3)">
                                <option value="377">雁栖</option>
                                <option value="378">桥梓</option>
                                <option value="379">怀柔城区</option>
                                <option value="380">渤海镇</option>
                                <option value="381">庙城</option>
                                <option value="382">怀柔周边</option>
                            </select>
                            <script>mod_street($('#bee_county3').val(), '3', '');</script>
                            <span class="add_street" onclick="del_street(3)">删除</span>
                        </div>
                        最多三个商圈&nbsp;&nbsp;<span class="add_street" onclick="add_street()">(再增加一个商圈)</span>
                    </td>
                </tr>
                <tr>
                    <th><span class="red">*</span>选择服务社区：</th>
                    <td>
                        <input type="hidden" id="mod_add_villages" value="">
                        <div id="villages_ids">
                            <div class="villages_ids1"><p>朝阳 安慧桥 附近的小区：</p>
                                <ul class="villages_ids1_ul">
                                    <li><input type="checkbox" name="add_villages" value="650" id="label_for_650"
                                               onclick="checkbox_village(650)"><label
                                            for="label_for_650">安慧东里1号院</label></li>
                                    <li><input type="checkbox" name="add_villages" value="1856" id="label_for_1856"
                                               onclick="checkbox_village(1856)"><label for="label_for_1856">本色空间</label>
                                    </li>
                                </ul>
                            </div>
                ...
                <tr>
                    ...
                    <td>
                        <input class="inp inw" type="text" maxlength="2" id="age" value="0"
                ...
                <tr>
                    ...
                    <td>
                        <input class="inp inw" type="text" id="ID_card" value="">
                    </td>
                </tr>
                <tr>
                    <th><span class="red">*</span> 真实姓名：</th>
                    <td>
                        <input class="inp inw" type="text" maxlength="15" value="" id="realname">
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div style="clear:both;">
                            <div style="clear:both;">
                                ...
                                <div style="float:left;"><input name="cert_degree" type="text" class="input"
                                                                id="cert_degree" title="双击查看图片"
                                                                ondblclick="veiwPic(this);" size="30" maxlength="255"
                                                                value=""></div>
                                <div style="clear:both;">
